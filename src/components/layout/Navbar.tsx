...
const dropdownMenus = [
  {
    title: "Solutions",
    links: [
      { href: "/business", key: "business" as const, description: "For Companies" },
...
export default function Navbar() {
  ...
  return (
    ...
    >
        ...
        <div className="flex h-16 md:h-20 items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            {dropdownMenus.map((menu) => (
              ...
              >
                <button
                  className="group flex items-center gap-1 px-4 py-2 text-sm font-medium text-foreground/80 hover:text-accent transition-colors"
                >
                  {menu.title}
                  ...
                  <div className="absolute top-full left-0 mt-1 w-48 bg-primary-darker/95 backdrop-blur-md border border-border rounded-lg shadow-xl py-2 z-50">
                    {menu.links.map((link) => (
                      ...
                      >
                        ...
                        <div className="text-xs text-foreground/50">{link.description}</div>
                      </Link>
                    ))}
                  </div>
                )}
      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 top-16 bg-primary-dark/98 backdrop-blur-lg z-40">
